#!/bin/bash
wget -O /home/george/optiminer-zcash-1.6.1.tar.gz https://github.com/Optiminer/OptiminerZcash/raw/master/optiminer-zcash-1.6.1.tar.gz
tar -xvf /home/george/optiminer-zcash-1.6.1.tar.gz -C /home/george
echo "#!/bin/bash
